...
-	Each business contact record contains basic information such as email, name and address. The application should access a simple database through a RESTful service. The UI is responsive and extremely performant.
...
-	A modern JavaScript UI framework of choice (Vue, React, Angular, DevExpreme, etc.)
-	An HTTP-based API layer (.Net Core 3.1 or later)
-	A database backend that reflects a production-based solution
-	ORM-based DB communication
